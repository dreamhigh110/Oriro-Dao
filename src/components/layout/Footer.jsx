...
const Footer = () => {
  ...
  const footerLinks = [
    ...
    },
    {
      title: 'Products',
      links: [
        { name: 'Tokens', path: '/marketplace/tokens' },
        { name: 'NFTs', path: '/marketplace/nfts' },
        { name: 'Bonds', path: '/marketplace/bonds' },
        { name: 'Multi-chain Bridge', path: '/bridge' },
        { name: 'Digital Banking', path: '/banking' },
      ]
    },
    {
      title: 'Resources',
  ...
  const socialLinks = [
    ...
    { name: 'GitHub', path: 'https://github.com', icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: 'Discord', path: 'https://discord.com', icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: 'Telegram', path: 'https://telegram.org', icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-400 max-w-md">
              A private decentralized DAO platform with multi-chain infrastructure, secure governance, digital banking integration, and a marketplace for tokens, NFTs, and bonds.
            </p>
